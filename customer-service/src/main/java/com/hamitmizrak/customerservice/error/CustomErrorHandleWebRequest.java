package com.hamitmizrak.customerservice.error;


import com.hamitmizrak.customerservice.utility.FrontEnd;
...
// http://localhost:1111/error => hata yakalama mekanizmasını yakalamak için
